...
const DoctorProfile = () => {
  ...
  const {dToken,profileData,setProfileData,getProfileData,backend_url}=useContext(DoctorContext)
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg  p-8 py-7 bg-white'>
          ...
          <div className='flex items-center gap-2 mt-1 text-gray-600'>
           ...
           {
            isEdit
            ?<button onClick={()=>updateProfile()} className='px-4 py-1 border border-primary text-sm rounded-full mt-5 hover:bg-[#5F6FFF] hover:text-white transition-all'>Save Information</button>
